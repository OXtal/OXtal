...
from oxtal.model.modules.primitives import LinearNoBias
from oxtal.model.modules.transformer import AtomAttentionEncoder
...
class InputFeatureEmbedder(nn.Module):
    ...
    def __init__(
        ...
        self.input_feature = {"restype": n_residues, "profile": n_residues, "deletion_mean": 1}
...
class RelativePositionEncoding(nn.Module):
    ...
    def forward(self, input_feature_dict: dict[str, Any]) -> torch.Tensor:
        ...
        feature_dict = ["asym_id", "residue_index", "entity_id", "token_index", "sym_id"]
        ...
        if self.training:
            ...
            b_same_entity_chunks = torch.chunk(b_same_entity.reshape(-1, 1), chunk_num, dim=-2)
